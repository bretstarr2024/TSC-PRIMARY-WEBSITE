        ...
        <div className="max-w-7xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <nav className="flex items-center gap-4">
              <a href="/dashboard" className="text-sm text-[#d1d1c6] hover:text-white transition-colors">Overview</a>
              <a href="/dashboard/write" className="text-sm text-[#d1d1c6] hover:text-white transition-colors">Write from URL</a>
            </nav>
          </div>
          <a
