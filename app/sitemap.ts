...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/working-together`, changeFrequency: 'monthly', priority: 0.8 },
    ...
    { url: `${BASE_URL}/examples`, changeFrequency: 'monthly', priority: 0.8 },
    ...CASE_STUDIES.map((cs) => ({
      url: `${BASE_URL}/examples/${cs.slug}`,
      changeFrequency: 'monthly' as const,
      priority: 0.7,
    })),
